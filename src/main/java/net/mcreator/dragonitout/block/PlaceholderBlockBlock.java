...
public class PlaceholderBlockBlock extends DragonItOutModElements.ModElement {
	@ObjectHolder("dragon_it_out:placeholder_block")
	public static final Block block = null;
	public PlaceholderBlockBlock(DragonItOutModElements instance) {
		super(instance, 7);
	}
