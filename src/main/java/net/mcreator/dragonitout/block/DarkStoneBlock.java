...
public class DarkStoneBlock extends DragonItOutModElements.ModElement {
	@ObjectHolder("dragon_it_out:dark_stone")
	public static final Block block = null;
	public DarkStoneBlock(DragonItOutModElements instance) {
		super(instance, 23);
	}
