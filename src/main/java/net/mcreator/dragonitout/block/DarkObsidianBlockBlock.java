...
public class DarkObsidianBlockBlock extends DragonItOutModElements.ModElement {
	@ObjectHolder("dragon_it_out:dark_obsidian_block")
	public static final Block block = null;
	public DarkObsidianBlockBlock(DragonItOutModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_obsidian_block");
		}
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, new OreFeature(OreFeatureConfig::deserialize) {
				...
				public boolean place(IWorld world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("dark_obsidian_block", "dark_obsidian_block", blockAt -> {
